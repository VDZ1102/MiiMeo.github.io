const textConfig = {
  ...
  text9: "Năm mới 2023 chúc Chutichacademy mãi keo và bạn Mii Meo luôn vui tươi xinh xắn trong mọi màu tóc 🤗 🤗 🤩 🤩", // mỗi bạn một câu chúc riêng đừng lộn
  text10: "Chúc mừng năm mới 2023",
  text11:
    "Lên lịch đi chơi thôi mấy hôm nữa tớ bận lắm - bận quần, bận áo đi bay cùng Động Thiểu á 😎😜😜",
  text12: "Okii lunn <3",
};
...
$(document).ready(function () {
  ...
  function firstQuestion() {
    ...
    Swal.fire({
      ...
      imageUrl: "img/Miixinhxinh.jpg",    //ảnh pop up đầu
      imageWidth: 300,
      imageHeight: 300,
